...
BEGIN
  ...
  ${replace ? 'CREATE OR REPLACE TABLE' : 'CREATE TABLE IF NOT EXISTS'} \`${ns_inst}.inst_summary_by_field_year\` AS (
    WITH
    A AS (SELECT * FROM \`${ns_core}.research_outputs_local_${digits}_institution_field_year\` WHERE institution = '${rorcode}'),
    B AS (SELECT * FROM \`${ns_core}.research_outputs_world_${digits}_institution_field_year\` WHERE institution = '${rorcode}'),
  ...
  ${replace ? 'CREATE OR REPLACE TABLE' : 'CREATE TABLE IF NOT EXISTS'} \`${ns_inst}.inst_summary_by_field\` AS (
    WITH
    A AS (SELECT * FROM \`${ns_core}.research_outputs_local_${digits}_institution_field\` WHERE institution = '${rorcode}'),
    B AS (SELECT * FROM \`${ns_core}.research_outputs_world_${digits}_institution_field\` WHERE institution = '${rorcode}'),
    C AS (SELECT code,name FROM ${ns_core}.core_fors)
    SELECT 
      A.field,
      C.name,
  ...
  ${replace ? 'CREATE OR REPLACE TABLE' : 'CREATE TABLE IF NOT EXISTS'} \`${ns_inst}.inst_summary_by_year\` AS (
    WITH
    A AS (SELECT * FROM \`${ns_core}.research_outputs_local_${digits}_institution_year\` WHERE institution = '${rorcode}'),
    B AS (SELECT * FROM \`${ns_core}.research_outputs_world_${digits}_institution_year\` WHERE institution = '${rorcode}')
    SELECT 
      A.year,
